...
with tf.Session() as sess:
    ...
    if FLAGS.is_train:
        ...
        mlp_model = Model(drop_rate=FLAGS.drop_rate)
        ...
        for epoch in range(FLAGS.num_epochs):
            ...
            if epoch % FLAGS.plot_epoch == 0:
                train_acc, train_loss = train_epoch(mlp_model, sess, X_train, y_train, plot=True, epoch=epoch)
            else:
                train_acc, train_loss = train_epoch(mlp_model, sess, X_train, y_train, plot=False)
